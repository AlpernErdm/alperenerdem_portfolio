...
export function Experience({ experiences }: ExperienceProps) {
  ...
  const sortedExperiences = [...experiences].sort((a, b) => {
    // Handle "Halen" (current) - should be first
    if (a.endDate === "Halen") return -1;
    if (b.endDate === "Halen") return 1;
  ...
  // Separate full-time/part-time from internships
    ...
    <section id="experience" className="py-12 sm:py-16 md:py-20 bg-muted/30" ref={ref}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {internships.length > 0 && (
          <div>
            <h3 className="text-xl sm:text-2xl font-bold mb-6 md:mb-8 text-center">Stajlar</h3>
